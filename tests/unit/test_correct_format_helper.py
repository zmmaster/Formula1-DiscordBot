...
class TestIsAlpha(unittest.TestCase):
    def test_all_digit(self):
        ...
        self.assertFalse(UrlBuilder.is_alpha(endpoint_variable))

    def test_all_alpha(self):
        endpoint_variable = "next"
        self.assertTrue(UrlBuilder.is_alpha(endpoint_variable))
...
class TestFormatHelper(unittest.TestCase):
    def test_correct_format_helper_both_correct_keywords(self):
        season = "current"
        rnd = "next"
        self.assertTrue(UrlBuilder.correct_format_helper(season, rnd))

    def test_correct_format_helper_both_incorrect_keywords(self):
        season = "curren"
        rnd = "lats"
        self.assertFalse(UrlBuilder.correct_format_helper(season, rnd))
